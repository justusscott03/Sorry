declare module "https://cdn.jsdelivr.net/gh/justusscott03/PJSLibrary@v1.1.3/colors.js" {
    ...
    export function lerpColor(color1: string, color2: string, amt: number): string;
}
...
declare module "https://cdn.jsdelivr.net/gh/justusscott03/PJSLibrary@v1.1.3/shapes.js" {
    ...
    export function triangle(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number): void;
    export function arc(x: number, y: number, w: number, h: number, start: number, stop: number): void;
}

declare module "https://cdn.jsdelivr.net/gh/justusscott03/PJSLibrary@v1.1.3/complexShapes.js" {
    export function beginShape(): void;
    export function vertex(x: number, y: number): void;
    export function endShape(): void;
}

declare module "https://cdn.jsdelivr.net/gh/justusscott03/PJSLibrary@v1.1.3/initPJS.js" {
    export function initPJS(): void;
}

declare module "https://cdn.jsdelivr.net/gh/justusscott03/PJSLibrary@v1.1.3/transformation.js" {
...
declare module "https://cdn.jsdelivr.net/gh/justusscott03/PJSLibrary@v1.1.3/text.js" {
    ...
    export function textWeight(weight: string): void;
}

declare module "https://cdn.jsdelivr.net/gh/justusscott03/PJSLibrary@v1.1.3/math.js" {
